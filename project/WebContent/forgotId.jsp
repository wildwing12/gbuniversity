 ...
 <style>
    ...
    <script type="text/javascript">
    	function forgot_id(){
    		...
    		$.ajax({
    			type:"post",
    			url:"${path}/GBController/stdforgotid.do",
    			data: {"stdname":stdname, "stdemail":stdemail},
...
<%--   <c:if test="${find==0}">
  <div id="searchId" class="text-danger">정보가 일치하지 않습니다.</div>
  </c:if>
  <c:if test="${find==1}">
  <p class="text-primary">당신의 아이디는 ${stdid}입니다.</p>
  </c:if> --%>
  <div id="result"></div>

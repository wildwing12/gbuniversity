...
<link href="css/bootstrap.min.css" rel="stylesheet" integrity="sha384-ggOyR0iXCbMQv3Xipma34MD+dH/1fQ784/j6cY/iJTQUOhcWr7x9JvoRxT2MZw1T" crossorigin="anonymous">
 <style>
  ...
  <h1 class="h3 mb-3 font-weight-normal">GB 비밀번호 찾기(교직원)</h1>
  <label for="inputEmail" class="sr-only">아이디</label>
  <input type="text" id="proid" name="proid" class="form-control" placeholder="아이디를 입력하세요" required autofocus>
...
function forgot_passwd() {
	document.forgotpw.action="${path}/GBController2/proforgotPw.do";
